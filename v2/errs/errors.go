...
var (
	...
	ErrMutexViolation               = i18n.NewError(ErrMutexViolationKey)
	ErrConflictingFlags             = i18n.NewError(ErrConflictingFlagsKey)
	ErrSingletonContractGroup       = i18n.NewError(ErrSingletonContractGroupKey)
	ErrInvalidContract              = i18n.NewError(ErrInvalidContractKey)
	ErrUnknownContract              = i18n.NewError(ErrUnknownContractKey)
	ErrContractArgs                 = i18n.NewError(ErrContractArgsKey)
	ErrFlagRequires                 = i18n.NewError(ErrFlagRequiresKey)
	ErrRequiredWhen                 = i18n.NewError(ErrRequiredWhenKey)
	ErrExactlyOneRequired           = i18n.NewError(ErrExactlyOneRequiredKey)
