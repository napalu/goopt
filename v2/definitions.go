...
type RequiredIfFunc func(cmdLine *CmdLine, optionName string) (bool, string)
...
type ConfigureCmdLineFunc func(cmdLine *CmdLine, err *error)
...
type CommandFunc func(cmdLine *CmdLine, command *Command) error
...
const (
	...
	// Standalone denotes a boolean Flag (optionally accepts a boolean value)
...
// ClearConfig allows to selectively clear a set of CmdLine configuration data
...
// CmdLine opaque struct used in all Flag/Command manipulation
type CmdLine struct {
